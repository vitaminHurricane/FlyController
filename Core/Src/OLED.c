...
/**
  ...
  */
void OLED_W_SCL(GPIO_PinState state)
{
...
/**
  ...
  */
void OLED_W_SDA(GPIO_PinState state)
{
...
void LEDState1_ON(void)
{
	OLED_ClearArea(25,1,24,16);
	OLED_ShowString(25, 1,"ON" ,OLED_8X16);
	OLED_Update();
}
void LEDState1_OFF(void)
{
	OLED_ClearArea(25,1,24,16);
	OLED_ShowString(25, 1,"OFF" ,OLED_8X16);
	OLED_Update();
}
void LEDState2_ON(void)
{
	OLED_ClearArea(25,20,24,16);
	OLED_ShowString(25, 20,"ON" ,OLED_8X16);
	OLED_Update();
}
void LEDState2_OFF(void)
{
	OLED_ClearArea(25,20,24,16);
	OLED_ShowString(25, 20,"OFF" ,OLED_8X16);
	OLED_Update();
}
void LEDState3_ON(void)
{
	OLED_ClearArea(25,40,24,16);
	OLED_ShowString(25, 40,"ON" ,OLED_8X16);
	OLED_Update();
}
void LEDState3_OFF(void)
{
	OLED_ClearArea(25,40,24,16);
	OLED_ShowString(25, 40,"OFF" ,OLED_8X16);
	OLED_Update();
}
